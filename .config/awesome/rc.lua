...
globalkeys = mytable.join(
    ...
    awful.key({ altkey }, "f", function () awful.spawn.with_shell("firefox") end,
    ...
    -- Bash Scripts
    awful.key({ altkey }, "d", function () awful.spawn.with_shell("bash ~/bash/dashboard.sh") end,
              {description = "dashboard", group = "launcher"}), 
    awful.key({ altkey }, "p", function () awful.spawn.with_shell("bash ~/bash/finance.sh") end,
              {description = "pay - finance", group = "launcher"}),
    awful.key({ altkey }, "t", function () awful.spawn.with_shell("bash ~/bash/timesheets.sh") end,
